...
char text3[]={"1) use arrow keys or mouse for navigation "};

char text4[]={"2) press enter or left mouse button to select the cube"};
...
char textd[]={"Mr.Deepak Rao"};

char texte[]={"Amrusha HM"};

char textf[]={"DS Sankusha"};

char textg[]={"4mw13cs007"};

char texth[]={"4mw13cs021"};
 ...
 status=1;
  ...
  void selects() //to select inner pattern
   {
       ...
       switch(r)
       {
        ...
        case 3:glColor3f(1,0.4,0.2);glutSolidCube(10);break;//black cube
        ...
        case 9:glColor3f(0.7,0.3,0.1);glutSolidSphere(10,30,30);break;//black Sphere
        ...
        case 15:glColor3f(1,0.4,0.2);glutSolidCube(10);break;//black cube
        ...
        case 18:glColor3f(0.7,0.3,0.1);glutSolidSphere(10,30,30);break;//black Sphere
  ...
  void  mycube()    //draw cube
	...
	*/
	...
	glColor3f(0.0,1.0,1.0); //two lines
	glBegin(GL_POLYGON);
	glVertex3fv(cube[0]);
	glVertex3fv(cube[1]);
	glVertex3fv(cube[3]);
  ...
  void disp()     //routine to rotate cube
   ...
   void display(void)    //display function
    {
	   ...
	   if(k==0)
		...
		//if there is no match purple cover should be there on unmatched when moving from one block to another	  
		if(x==1||y==1)
		match[1]=1;
	       ...
	       else
		{
		  ...
		  //if there is no match purple cover should be there on the unmatched boxes when any box is clicked
		if(match[1]!=1)
		if(status!=1 && status_count1!=1)
		  {
			glTranslatef(80,-80,0);
   ...
   void mouse(int btn,int state, int x,int y)
   {
	   ...
	   if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
	   {
	    ...
	    if((x>=24&&x<=174)&&(y>=20&&y<=143))
		{
			printf("ïn 1");
			x1 = 100,yl = -60,x2 = 100,y2 = -100,x3 = 60,y3 = -100,x4 = 60,y4 = -60;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		else if((x>=225&&x<=375)&&(y>=20&&y<=143))
		{
			printf("in 2");
			x1 = 60,yl = -60,x2 = 60,y2 = -100,x3 = 20,y3 = -100,x4 = 20,y4 = -60;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
	    ...
	    else if((x>=426&&x<=574)&&(y>=20&&y<=143))
		{
			x1 = 20,yl = -60,x2 = 20,y2 = -100,x3 = -20,y3 = -100,x4 = -20,y4 = -60;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		else if((x>=625&&x<=775)&&(y>=20&&y<=143))
		{
			x1 = -20,yl = -60,x2 = -20,y2 = -100,x3 = -60,y3 = -100,x4 = -60,y4 = -60;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		else if((x>=825&&x<=974)&&(y>=20&&y<=143))
		{
			x1 = -60,yl = -60,x2 = -60,y2 = -100,x3 = -100,y3 = -100,x4 = -100,y4 = -60;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
	    ...
	    else if((x>=24&&x<=174)&&(y>=184&&y<=309))
		{
			x1 = 100,yl = -20,x2 = 100,y2 = -60,x3 = 60,y3 = -60,x4 = 60,y4 = -20;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		else if((x>=225&&x<=375)&&(y>=184&&y<=309))
		{
			x1 = 60,yl = -20,x2 = 60,y2 = -60,x3 = 20,y3 = -60,x4 = 20,y4 = -20;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
	    ...
	    if((x>=426&&x<=574)&&(y>=184&&y<=309))
		{
			x1 = 20,yl = -20,x2 = 20,y2 = -60,x3 = -20,y3 = -60,x4 = -20,y4 = -20;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		if((x>=625&&x<=775)&&(y>=184&&y<=309))
		{
			x1 = -20,yl = -20,x2 = -20,y2 = -60,x3 = -60,y3 = -60,x4 = -60,y4 = -20;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		if((x>=825&&x<=975)&&(y>=184&&y<=309))
		{
			x1 = -60,yl = -20,x2 = -60,y2 = -60,x3 = -100,y3 = -60,x4 = -100,y4 = -20;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
	    ...
	    if((x>=24&&x<=174)&&(y>=349&&y<=474))
		{
			x1 = 100,yl = 20,x2 = 100,y2 = -20,x3 = 60,y3 = -20,x4 = 60,y4 = 20;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		if((x>=225&&x<=375)&&(y>=349&&y<=474))
		{
			x1 = 60,yl = 20,x2 = 60,y2 = -20,x3 = 20,y3 = -20,x4 = 20,y4 = 20;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
	    ...
	    if((x>=426&&x<=574)&&(y>=349&&y<=474))
		{
			x1 = 20,yl = 20,x2 = 20,y2 = -20,x3 = -20,y3 = -20,x4 = -20,y4 = 20;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		if((x>=625&&x<=775)&&(y>=349&&y<=474))
		{
			x1 = -20,yl = 20,x2 = -20,y2 = -20,x3 = -60,y3 = -20,x4 = -60,y4 = 20;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
	    ...
	    if((x>=825&&x<=975)&&(y>=349&&y<=474))
		{
			x1 = -60,yl = 20,x2 = -60,y2 = -20,x3 = -100,y3 = -20,x4 = -100,y4 = 20;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
	    ...
	    if((x>=24&&x<=174)&&(y>=514&&y<=639))
		{
			x1 = 100,yl = 60,x2 = 100,y2 = 20,x3 = 60,y3 = 20,x4 = 60,y4 = 60;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		if((x>=225&&x<=375)&&(y>=514&&y<=639))
		{
			x1 = 60,yl = 60,x2 = 60,y2 = 20,x3 = 20,y3 = 20,x4 = 20,y4 = 60;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
	    ...
	    if((x>=426&&x<=574)&&(y>=514&&y<=639))
		{
			x1 = 20,yl = 60,x2 = 20,y2 = 20,x3 = -20,y3 = 20,x4 = -20,y4 = 60;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		if((x>=625&&x<=775)&&(y>=514&&y<=639))
		{
			printf("in 19");
			x1 = -20,yl = 60,x2 = -20,y2 = 20,x3 = -60,y3 = 20,x4 = -60,y4 = 60;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
		...
		if((x>=825&&x<=975)&&(y>=514&&y<=639))
		{
			x1 = -60,yl = 60,x2 = -60,y2 = 20,x3 = -100,y3 = 20,x4 = -100,y4 = 60;
			rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
			if(btn==GLUT_LEFT_BUTTON&&state==GLUT_DOWN)
			{
				counter_fn();
